      ...
      <div className="flex w-fit flex-wrap gap-1 rounded-full bg-white/80 p-1 shadow-apple">
        {mintTabs.map((tab) => (
          <button
            ...
            className={`rounded-full px-4 py-2 text-[12px] font-semibold uppercase tracking-[0.08em] transition-colors ${activeTab === tab.id
            ...
            <div className="flex w-fit flex-wrap gap-1 rounded-full bg-accent p-1">
              {batchModes.map((mode) => (
                <button
                  ...
                  className={`rounded-full px-4 py-2 text-[12px] font-medium uppercase tracking-[0.08em] transition-colors ${batchMode === mode.id
